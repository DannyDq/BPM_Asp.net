...
namespace Fiodariane.Controllers
{
    public class ProceduresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProcedureID,Name,Link")] Procedure procedure)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProcedureID,Name,Link")] Procedure procedure)
        {
            if (ModelState.IsValid)
            {
